...
public class MainActivity extends Activity {
    ...
    private String inflateUi() {
        try {
            String encoded = readAsset("ui_1.txt") + readAsset("ui_2.txt") + readAsset("ui_3.txt") + readAsset("ui_4.txt");
            ...
            return "<html><body style='background:#07110e;color:white;font-family:sans-serif;padding:24px'><h2>SureBet Live</h2><p>UI konnte nicht geladen werden.</p><small>" + JSONObject.quote(e.getMessage()) + "</small></body></html>";
        }
    }
